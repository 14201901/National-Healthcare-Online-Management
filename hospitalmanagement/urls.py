...
urlpatterns = [
    ...
    path('hospitalclick', views.hospitalclick_view),
...
urlpatterns += [
    ...
    path('doctor-approve-appointment/<int:pk>', views.doctor_approve_appointment, name='approve-appointment'),
]
